...
if __name__ == "__main__":
    ...
    emotion_label = emotion_classification(wav_file, transcript)
    print("emotion label:\n", emotion_label)
    print("🤖 Ollama Llama Terminal Chat (Ctrl+C to exit)")
    emotion = emotion_label.strip()
    text = transcript.strip()
    reply = response_llama(text, emotion)
    print(f"Ollama Llama: {reply}")
